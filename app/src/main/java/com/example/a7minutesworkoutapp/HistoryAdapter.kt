...
import kotlinx.android.synthetic.main.items_history_row.view.*
...
class HistoryAdapter(val context: Context, val items: ArrayList<String>):
    ...
    class ViewHolder(view: View): RecyclerView.ViewHolder(view){
        val llHistoryMainItem = view.ll_history_items
        val tvItem = view.tvItem
        val tvPosition = view.tvPosition
    }

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        return ViewHolder(LayoutInflater.from(context).inflate(R.layout.items_history_row,parent,false))
    }
