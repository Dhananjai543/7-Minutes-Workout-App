...
class SqliteOpenHelper(context: Context, factory: SQLiteDatabase.CursorFactory?) :
    ...
    companion object{
        ...
        private val DATABASE_NAME = "SevenMinutesWorkoutApp.db"
    ...
    override fun onCreate(db: SQLiteDatabase?) {
        val CREATE_EXERCISE_TABLE = ("CREATE TABLE "+ TABLE_HISTORY +"("+ COLUMN_ID+" INTEGER PRIMARY KEY, "+ COLUMN_COMPLETED_DATE
        + " TEXT)")
